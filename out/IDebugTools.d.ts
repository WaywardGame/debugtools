...
export declare enum DebugToolsTranslation {
    ...
    ButtonNextItems = 137,
    LabelItems = 138,
    LabelReplaceData = 139,
    ButtonReplace = 140,
    InspectionTemperature = 141,
    InspectionTemperatureBiome = 142,
    InspectionTemperatureBiomeTimeModifier = 143,
    InspectionTemperatureLayerModifier = 144,
    InspectionTemperatureLayerTimeModifier = 145,
    InspectionTemperatureTileCalculated = 146,
    InspectionTemperatureTileCalculatedHeat = 147,
    InspectionTemperatureTileCalculatedCold = 148,
    InspectionTemperatureTileProducedHeat = 149,
    InspectionTemperatureTileProducedCold = 150,
    ActionResurrect = 151,
    ActionClone = 152,
    ActionTeleport = 153,
    To = 154,
