...
export declare enum DebugToolsTranslation {
    ...
    ButtonLoadMore = 148,
    InspectionTemperature = 149,
    InspectionTemperatureBiome = 150,
    InspectionTemperatureBiomeTimeModifier = 151,
    InspectionTemperatureLayerModifier = 152,
    InspectionTemperatureLayerTimeModifier = 153,
    InspectionTemperatureTileCalculated = 154,
    InspectionTemperatureTileCalculatedHeat = 155,
    InspectionTemperatureTileCalculatedCold = 156,
    InspectionTemperatureTileProducedHeat = 157,
    InspectionTemperatureTileProducedCold = 158,
    ActionResurrect = 159,
    ActionClone = 160,
    ActionTeleport = 161,
    To = 162,
