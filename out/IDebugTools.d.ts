...
export declare enum DebugToolsTranslation {
    ...
    ButtonLoadMore = 148,
    LabelValue = 149,
    LabelMagicalPropertyAdd = 150,
    ButtonRemoveAllMagicalProperties = 151,
    InspectionTemperature = 152,
    InspectionTemperatureBiome = 153,
    InspectionTemperatureBiomeTimeModifier = 154,
    InspectionTemperatureLayerModifier = 155,
    InspectionTemperatureLayerTimeModifier = 156,
    InspectionTemperatureTileCalculated = 157,
    InspectionTemperatureTileCalculatedHeat = 158,
    InspectionTemperatureTileCalculatedCold = 159,
    InspectionTemperatureTileProducedHeat = 160,
    InspectionTemperatureTileProducedCold = 161,
    ActionResurrect = 162,
    ActionClone = 163,
    ActionTeleport = 164,
    To = 165,
