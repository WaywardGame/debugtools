...
export default class DebugTools extends Mod {
    ...
    getPlayerSpriteBatchLayer(_: any, player: Player, batchLayer: SpriteBatchLayer): SpriteBatchLayer | undefined;
    isHumanSwimming(human: Human, isSwimming: boolean): boolean | undefined;
    getPlayerMaxWeight(player: Player, weight: number): number;
