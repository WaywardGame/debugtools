 ...
 */
export default new Action(anyOf(ActionArgument.Container, ActionArgument.Player), ActionArgument.Integer32, ActionArgument.Quality, ActionArgument.Integer32)
